effect effects/weapons/smccoraloscillator/impact_default
{
	size	1110
	...
	spawner "x_fill2"
	{
		...
		sprite
		{
			...
			start
			{
				...
				size { point 100,100 }
				tint { line 1,0.501961,0.501961,0.607843,0,0 }
				fade { line 0.5,1 }
	...
	spawner "x_fill3"
	{
		...
		sprite
		{
			...
			start
			{
				...
				size { point 100,100 }
				tint { line 1,0.501961,0.501961,0.768628,0,0 }
				fade { line 0.5,1 }
				offset { box 0,-100,-100,0,100,100 }
				rotate { box 0,1 }
			}
